...
const GLYPHS: Record<string, Glyph> = {
  ...
  settings: {
    nodes: (
      <>
        <circle cx="12" cy="12" r="3" />
        <path d="m19.4 15 .1.1 1.4 1.1-1.4 2.4-1.7-.7a7.5 7.5 0 0 1-1.5.9l-.3 1.8h-2.8l-.3-1.8a7.5 7.5 0 0 1-1.5-.9l-1.7.7-1.4-2.4 1.4-1.1a7.2 7.2 0 0 1 0-1.8l-1.4-1.1 1.4-2.4 1.7.7a7.5 7.5 0 0 1 1.5-.9l.3-1.8h2.8l.3 1.8a7.5 7.5 0 0 1 1.5.9l1.7-.7 1.4 2.4-1.4 1.1a7.2 7.2 0 0 1 0 1.7Z" />
      </>
    ),
  },
