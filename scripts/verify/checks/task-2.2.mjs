#!/usr/bin/env node
// Task 2.2 check: domain entities, LyricsCandidate/Song/LibraryRoot/PlaylistMember.
//
...
function fail(step, msg) {
  process.stderr.write(`FAIL 2.2: ${step}: ${msg}\n`);
  process.exit(1);
}
...
process.stdout.write("ok 2.2: domain entities, LyricsCandidate/Song/LibraryRoot/PlaylistMember\n");
